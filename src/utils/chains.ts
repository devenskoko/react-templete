...
const getInfuraUrlFor = (network: string) => `https://${network}.infura.io/v3/84842078b09946638c03157f83405213`;
const getAlchemyUrlFor = (network: string) => `https://${network}.alchemyapi.io/v2/_gg7wSSi0KMBsdKnGVfHDueq6xMB9EkC`;
